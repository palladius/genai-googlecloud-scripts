...
At the beginning of the game, ask me for difficulty EASY, MEDIUM, DIFFICULT. Depending on the choice make the speed and interval smaller (current timing is very easy, good for my little one but not for me.)

From a visualization side, make sure to increase the font of numbers, add a space between operator and number, and visualize "*2" as "X 2". Ideally I'd like to make the operator font bigger than number font.
