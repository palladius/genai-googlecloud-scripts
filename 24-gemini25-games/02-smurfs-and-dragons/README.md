...
See the game in action: https://smurfs-and-dragons.web.app/

## INSTALL

* `npm install firebase-tools`
* If you're not me, change project_id in `.firebaserc`.
* `just deploy`

## prompt 1 execution 2
...
console: https://firebase.corp.google.com/project/smurfs-and-dragons/overview?pli=1
Exec 1: boh
Exec 2: https://gemini.google.com/corp/app/c1373c4084bc37fe
