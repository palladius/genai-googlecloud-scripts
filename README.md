...
|Invoke a textual prompt with pure Ruby: text, code images and embeddings. This is a Ruby wrap around public bash docs |[06-ruby-text-code-embeddings-images/](06-ruby-text-code-embeddings-images/) | Bash, Palm API (Text/Code/Embeddings/Images)|
